...
myDog.bark();  // Rex barks.
  //? Bu örnekte class ve extends sözcüklerini kullanarak Dog sınıfının Animal sınıfından kalıtım almasını sağladık. super() çağrısı ile üst sınıfın (Animal) yapıcı fonksiyonunu çağırıyoruz.