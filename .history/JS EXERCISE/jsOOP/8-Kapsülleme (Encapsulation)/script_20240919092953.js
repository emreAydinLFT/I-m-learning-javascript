...
//* Hesap sınıfının _bakiye özelliği private olarak tanımlanmıştır, böylece dışarıdan doğrudan değiştirilemez.
//* get bakiye() metodu, _bakiye özelliğine erişim sağlar.
set bakiye(yeniBakiye) metodu, _bakiye özelliğine değer atamadan önce kontrol yapar ve hata fırlatabilir.
paraYatir ve paraCek metotları, _bakiye özelliği üzerinde işlemler yapar, ancak dışarıdan doğrudan erişim gerektirmez.