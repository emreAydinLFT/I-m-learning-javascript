...
//! Abstract Metotlar (Soyut Metotlar)
//? Tanım: Sadece imzası olan, gövdesi olmayan metotlardır. Soyut sınıflarda kullanılır ve alt sınıflarda mutlaka override edilmelidir.
//* Amaç: Bir sınıf hiyerarşisinde ortak bir davranışın zorunlu kılındığını belirtmek ve alt sınıflara bu davranışı gerçekleştirme sorumluluğunu vermektir.
