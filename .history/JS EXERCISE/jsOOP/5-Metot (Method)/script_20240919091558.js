...
class Dikdortgen implements sek {
...
//* Açıklama: Sek interface'i, bir şeklin sahip olması gereken alanHesapla ve cevreHesapla metotlarını tanımlar. Dikdortgen sınıfı bu interface'i uyguladığı için bu metotları gerçekleştirmek zorundadır.
