document.getElementById("signupForm").addEventListener("submit", function (event) {
    ...
    if (email1.value === "" || email2.value === "" || parola1.value === "" || parola2.value === "" || phone.value === "" || countries.value === "") {
        ...
        if (email1.value === "") email1.classList.add("error");
        if (email2.value === "") email2.classList.add("error");
        if (parola1.value === "") parola1.classList.add("error");
        if (parola2.value === "") parola2.classList.add("error");
        if (phone.value === "") phone.classList.add("error");
        if (countries.value === "") countries.classList.add("error");
        return false;
    }
