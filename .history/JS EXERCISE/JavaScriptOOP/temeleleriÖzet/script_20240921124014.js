...
//! 2. Getter ve Setter Metotları ile Kapsülleme
...
//! 3. Sınıflar ve Özellikler ile Kapsülleme
//? ES6 ile gelen sınıflar, özellikler (properties) ve metotlar (methods) aracılığıyla kapsüllemeyi daha kolay hale getirir.

class Product {
    #price; // Özel değişken (private)
  ...
  let product = new Product("Telefon", 5000);
  console.log(product.price); // 5000
  // console.log(product.#price); // Hata: Özel değişkene dışarıdan erişilemez
  //? #price özel değişkeni, sınıfın özel bir değişkeni olarak tanımlanır ve dışarıdan erişilemez.
  //? price özelliği ise getter metodu ile dışarıdan okunabilir hale getirilmiştir.
//! 5. Polimorfizm
