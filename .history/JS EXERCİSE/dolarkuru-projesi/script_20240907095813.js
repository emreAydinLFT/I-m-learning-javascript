...
.then((data) => {                           // 3. JSON formatındaki veri 'data' olarak alınır ve bir sonraki 'then' bloğuna aktarılır.
    console.log(data.conversion_rates);     // 4. 'data' içindeki 'conversion_rates' adlı özelliği (muhtemelen döviz kurları) konsola yazdırır.
